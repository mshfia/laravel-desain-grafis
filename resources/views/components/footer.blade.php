<footer class="bg-gradient-to-r from-[rgba(14,83,112,0.7)] via-[rgba(173,94,45,0.7)] to-[rgba(121,155,193,0.7)]">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex flex-col md:flex-row items-center justify-between">
      <!-- Brand Info -->
      <div class="flex items-center mb-3 md:mb-0">
        <h3 class="text-white text-lg font-semibold mr-4">KaryaKu</h3>
        <p class="text-gray-100 text-sm opacity-90 hidden sm:block">
          Solusi desain profesional untuk kebutuhan kreatif Anda.
        </p>
      </div>

      <!-- Social Media + Copyright in one line -->
      <div class="flex items-center space-x-6">
        <!-- Social Media -->
        <div class="flex space-x-3">
          <a href="#" class="text-gray-100 hover:text-white transition opacity-90 hover:opacity-100">
        ...
        <!-- Copyright -->
        <p class="text-gray-100 text-xs opacity-80 border-l border-white/20 pl-3">
          © 2025 KaryaKu
        </p>
      </div>
    </div>
