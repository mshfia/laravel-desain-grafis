    ...
    <section id="portfolio" class="py-16 bg-white mt-5">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div class="text-center md:text-left">
            <h2 class="text-3xl font-bold text-gray-800 sm:text-4xl">
              Karya <span class="bg-gradient-to-r from-[rgba(14,83,112,0.7)] via-[rgba(173,94,45,0.7)] to-[rgba(121,155,193,0.7)] bg-clip-text text-transparent">Kreatif</span>
            </h2>
        ...
        <div class="container mx-auto px-4 py-6">
            <h2 class="text-2xl font-bold text-center mb-6">Daftar Karya</h2>
            ...
            <div 
                ...
                x-data="{
                projects: {{ Js::from($portfolio->map(function($item) {
                    return [
                        'id' => $item->id,
                        'title' => $item->judul,
