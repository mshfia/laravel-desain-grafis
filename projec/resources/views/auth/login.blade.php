...
<body class="bg-white font-poppins min-h-screen flex items-center justify-center p-4">
    <!-- Decorative Elements -->
    <div class="fixed top-10 left-10 w-32 h-32 rounded-full bg-[rgba(14,83,112,0.1)] animate-float"></div>
    <div class="fixed bottom-20 right-20 w-40 h-40 rounded-full bg-[rgba(173,94,45,0.1)] animate-float-delay"></div>
    <div class="fixed top-1/3 right-1/4 w-24 h-24 rounded-full bg-[rgba(121,155,193,0.1)] animate-float"></div>
    
    <!-- Main Login Container -->
    <div class="w-full max-w-md bg-white rounded-3xl shadow-lg overflow-hidden z-10 border border-gray-100 transition-all duration-500 hover:shadow-xl">
        <!-- Decorative Header -->
        ...
        <div class="p-8 pt-12">
            <form  action="{{ route('login') }}" method="post" class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <label for="email" class="absolute left-4 top-3 text-gray-400 transition-all duration-300 pointer-events-none peer-focus:text-[rgba(14,83,112,0.9)]">
                        Email Address
                    </label>
                </div>
                @error('email')
                ...
                <div class="relative mt-8">
                    <input type="password" id="password" name="password" placeholder=" "
                        class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[rgba(14,83,112,0.7)] focus:ring-2 focus:ring-[rgba(14,83,112,0.1)] outline-none transition duration-300 peer input-focus-effect">
                    <label for="password" class="absolute left-4 top-3 text-gray-400 transition-all duration-300 pointer-events-none peer-focus:text-[rgba(14,83,112,0.9)]">
                        Password
                    </label>
                    ...
                    @error('password')
                    <small class="text-danger">{{ $message }}</small>  <!-- text-danger bukan text-denger -->
                    @enderror
                <!-- Remember & Forgot -->
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input 
                            type="checkbox" 
                            id="remember"
                            class="w-4 h-4 text-[rgba(14,83,112,0.9)] rounded border-gray-300 focus:ring-[rgba(14,83,112,0.5)]"
                        >
                        <label for="remember" class="ml-2 text-sm text-gray-600">Remember me</label>
                    </div>
                    <a href="#" class="text-sm text-[rgba(14,83,112,0.9)] hover:text-[rgba(14,83,112,1)] font-medium">Forgot password?</a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-[rgba(14,83,112,0.9)] hover:text-[rgba(14,83,112,1)]">Sign up</a>
                </p>
            </div>
        </div>
    </div>
